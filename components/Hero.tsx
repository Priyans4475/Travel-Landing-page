  ...
  return (
   ...
   {/*left*/}
    ...
    <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
     ...
     We can help you on an adventure around the world in
      just one app
     ...
     <div className='relative flex flex-1 items-start'>
      <div className='relative z-20 flex w-[258px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8'>
        ...
        <div className='flex flex-col'>
          ...
          <p className='bold-20 text-white'>Bhilai</p>
        </div>
        <div className='flexBetween'>
          <div className='flex flex-col'>

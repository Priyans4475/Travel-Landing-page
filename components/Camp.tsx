...
const CampSite=({backgroundImage,title,subtitle,peopleJoined}: CampProps)=>{
  return (
    ...
    bg-cover bg-no-repeat lg:rounded-r-5xl lg:rounded-l-5xl 2xl:rounded-5xl`}>
...
const Camp = () => {
  return (
    <section className=' 2xl:max-container relative flex flex-col
     px-12 py-10 lg:mb-10 lg:py-20 xl:mb-20'>
      ...
      title="Bhilai Power House"
      subtitle="Supela, Bhilai"
      ...
      <div className='flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6'>
        ...
        xl:rounded-5xl xl:px-16 xl:py-20 relative w-full first-letter:overflow-hidden rounded-3xl'>
          <h2
          className='regular-24 md:regular-32 lg:regular-40 2xl:regular-64 capitalize text-white'>
